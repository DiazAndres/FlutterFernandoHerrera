...
import 'package:pokeapi/features/pokemon/presentation/widgets/pokemon_card.dart';

import '../bloc/search_pokemon/search_pokemon_bloc.dart';
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    TextButton(
                      onPressed:
                          () => BlocProvider.of<SearchPokemonBloc>(
                            context,
                          ).add(OnSearchPokemon()),
